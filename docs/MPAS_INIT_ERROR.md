...
export MPAS_ROOT=/mnt/lustre/users/msovara/SoftwareBuilds/MPAS
...
```bash
export LD_LIBRARY_PATH=/mnt/lustre/users/msovara/SoftwareBuilds/MPAS/lib64:/mnt/lustre/users/msovara/SoftwareBuilds/MPAS/build/MPAS-Model/build_cmake/lib:/apps/compilers/intel/parallel_studio_xe_2016/compilers_and_libraries/linux/lib/intel64:$LD_LIBRARY_PATH
...
strings /mnt/lustre/users/msovara/SoftwareBuilds/MPAS/bin/mpas_atmosphere | grep -i 'namelist\|streams\|required\|error' | head -20
```
...
#!/bin/bash
cd /mnt/lustre/users/msovara/SoftwareBuilds/MPAS/build/MPAS-Model/build_cmake
export LD_LIBRARY_PATH=./lib:/mnt/lustre/users/msovara/SoftwareBuilds/MPAS/lib64:/apps/compilers/intel/parallel_studio_xe_2016/compilers_and_libraries/linux/lib/intel64:$LD_LIBRARY_PATH
